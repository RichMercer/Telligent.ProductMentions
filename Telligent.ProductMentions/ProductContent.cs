...
namespace Mentions
{
    ...
    {
        public static IList<ProductContent> SampleData;
        ...
        {
            SampleData = new List<ProductContent>
            {
                new ProductContent
                {
                ...
                new ProductContent
                {
                    ...
                    Url = "http://www.amazon.com/dp/B002ZVOLX4/ref=s9_acsd_bw_wf_a_wfgard_cdl_1?pf_rd_m=ATVPDKIKX0DER&pf_rd_s=merchandised-search-6&pf_rd_r=0CRTP9B8XAG1V0BZ567B&pf_rd_t=101&pf_rd_p=ab92b836-6d03-48dc-9fbf-ad3d853481f4&pf_rd_i=12717570011"
                }
            };
        }
        ...
        {
            // TODO: Pull the records from your data source based on the Guid contentId.
            // You will need to add a Guid Id to your data if one doesn't already exist that will be used for future lookups.
        ...
        {
            // TODO: Replace this with a query that searches your data.
